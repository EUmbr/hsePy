...
class PopupWindowGet1_2():
    def __init__(self):
        ...
        self.var = tk.IntVar()
        self.var.set(0)
        self.r1 = ttk.Radiobutton(f2, text="Фамилия", variable=self.var,
                                  value=0)
        self.r2 = ttk.Radiobutton(f2, text="Имя", variable=self.var, value=1)
        self.r3 = ttk.Radiobutton(f2, text="Математика", variable=self.var,
                                  value=2)
        self.r4 = ttk.Radiobutton(f2, text="Русский язык", variable=self.var,
                                  value=3)
        self.r5 = ttk.Radiobutton(f2, text="Доп. предмет", variable=self.var,
                                  value=4)
        self.r6 = ttk.Radiobutton(f2, text="Доп. баллы", variable=self.var,
                                  value=5)
        self.r7 = ttk.Radiobutton(f2, text="Город", variable=self.var, value=6)
        self.r8 = ttk.Radiobutton(f2, text="Все числовые атрибуты",
        ...
        self.r8.grid(row=7, column=0, sticky='W', padx=20, pady=5)
